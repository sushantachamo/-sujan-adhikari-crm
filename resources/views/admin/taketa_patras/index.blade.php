            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body row">
                        ...
                        <div class="col-md-2">
                            <label>पत्र किसिम</label>
                            {!! Form::select('filter_letter_type', $data['letter_types'], isset($data['request']['filter_letter_type'])?$data['request']['filter_letter_type']:null, ['class' => 'form-control form-control-sm']) !!}
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="Date">किस्ता भुक्तानी मिति देखि:</label>
                        ...
                        <div class="col-md-2">
                             <div class="form-group">
                                <label for="Date">किस्ता भुक्तानी मिति सम्म:</label>
                                <div class="input-group">
            ...
            <div class="col-md-12">
                ...
                <div class="table-responsive" id="printable" >
                    <table class="table table-hover table-bordered table-sm">
                                ...
                                @if($data['is_trash'] == false)
                                    ...
                                    <div class="btn-group">
                                        <a type="button" href="{{ route($base_route.'.create') }}"
                                            ...
                                            <i class="fa fa-plus"></i> नयाँ ताकेता पत्र 
                                        </a>
                                    </div>
                                    @endcan
                        ...
                        <tr>
                            <th class="bb-0 font-weight-bold ">पत्र आईडी</th>
                            @hasrole('super-admin')
                            ...
                            <th class="bb-0 font-weight-bold fs--14 min-w-100"> पत्र किसिम </th>
                            <th class="bb-0 font-weight-bold fs--14 min-w-100"> जम्मा वाँकी</th>
                        ...
                        @if ($data['rows']->count() > 0)
                            ...
                            @foreach($data['rows'] as $row)
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>{{config('custom.letter_type.'.$row->letter_type) }}</td>
                                    <td> {!! $row->total == null?'N/A':$row->total  !!} </td>
                                    <td>
                                    ...
                                    <td class="no_print">
                                        <div class="btn-group">
                                            ...
                                            <a type="button" href="{{ route($base_route.'.edit', ['taketa_patra'=>$row->id]) }}"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#form-filter-btn').click(function () {
                ...
                var letter_type = $('select[name="filter_letter_type"]').val();
                ...
                if (letter_type) {
                    if (flag) {
                        url = url + '&filter_letter_type=' + letter_type;
                    } else {
                        url = url + '?filter_letter_type=' + letter_type;
                        flag = true;
                    }
