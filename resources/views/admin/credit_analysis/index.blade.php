            ...
            <div class="col-md-12">
                ...
                <div class="table-responsive" id="printable" >
                    <table class="table table-hover table-bordered table-sm">
                                ...
                                @if($data['is_trash'] == false)
                                    ...
                                    <div class="btn-group">
                                        <a type="button" href="{{ route($base_route.'.create') }}"
                                            ...
                                            <i class="fa fa-plus"></i> नयाँ ऋण अनुसन्धान 
                                        </a>
                                    </div>
                                    @endcan
                        ...
                        <tr>
                            <th class="bb-0 font-weight-bold ">अनुसन्धान आईडी</th>
                            @hasrole('super-admin')
                            ...
                            <th class="bb-0 font-weight-bold fs--14 min-w-100"> प्राप्ताङक  </th>
                        ...
                        @if ($data['rows']->count() > 0)
                            ...
                            @foreach($data['rows'] as $row)
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td> {!! $row->grand_total == null?'N/A':$row->grand_total  !!} </td>
                                    <td>
                                    ...
                                    <td class="no_print">
                                        <div class="btn-group">
                                            ...
                                            <a type="button" href="{{ route($base_route.'.edit', ['credit_analysi'=>$row->id]) }}"
