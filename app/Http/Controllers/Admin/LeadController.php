...
class LeadController extends BaseController
{
    ...
    public function getApplicationDetailsById($id)
    {
        ...
        $data['activityLog'] = ActivityLog::select('users.name', 'activity_logs.action', 'activity_logs.message')->where('activity_logs.panel_id', $id)->where('activity_logs.panel', 'task')->join('users', 'users.id', 'activity_logs.user_id')->orderBy('activity_logs.created_at', 'DESC')->get();
