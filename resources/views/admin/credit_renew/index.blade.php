                    ...
                    <div class="card-body row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="Date">नविकरण गर्ने निर्णय मिति देखि:</label>
                        ...
                        <div class="col-md-3">
                             <div class="form-group">
                                <label for="Date">नविकरण गर्ने निर्णय मिति सम्म:</label>
                                <div class="input-group">
            ...
            <div class="col-md-12">
                ...
                <div class="table-responsive" id="printable" >
                    <table class="table table-hover table-bordered table-sm">
                                ...
                                @if($data['is_trash'] == false)
                                    ...
                                    <div class="btn-group">
                                        <a type="button" href="{{ route($base_route.'.create') }}"
                                            ...
                                            <i class="fa fa-plus"></i> नविकरण फारम 
                                        </a>
                                    </div>
                                    @endcan
                        ...
                        <tr>
                            <th class="bb-0 font-weight-bold ">नविकरण आईडी</th>
                            @hasrole('super-admin')
                            ...
                            <th class="bb-0 font-weight-bold fs--14 min-w-100"> नविकरण रकम  </th>
                            <th class="bb-0 font-weight-bold fs--14 min-w-100"> व्याजदर</th>
                            <th class="bb-0 font-weight-bold fs--14 min-w-100"> नविकरण गर्ने निर्णय मिति</th>
                        ...
                        @if ($data['rows']->count() > 0)
                            ...
                            @foreach($data['rows'] as $row)
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>{{ $row->renew_amount }}</td>
                                    <td>{{ $row->renew_loan_interest_rate }}</td>
                                    <td>@if($row->renew_decision_date) 
                                        <span class="nepaliDate" englishDate="{{ $row->renew_decision_date->format('Y-m-d') }}"></span>
                                        @endif
                                    </td>
                                    <td>
                                    ...
                                    <td class="no_print">
                                        <div class="btn-group">
                                            ...
                                            <a type="button" href="{{ route($base_route.'.edit', ['credit_renew'=>$row->id]) }}"
